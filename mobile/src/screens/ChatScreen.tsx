...
const styles = StyleSheet.create({
  ...
  inputRow: { flexDirection: 'row', alignItems: 'flex-end', padding: 12, paddingBottom: 24, borderTopWidth: 1, borderColor: '#111133', backgroundColor: '#060611' },
  input: { flex: 1, backgroundColor: '#0d0d1e', borderRadius: 24, paddingHorizontal: 18, paddingVertical: 12, color: '#fff', fontSize: 15, borderWidth: 1, borderColor: '#111133', maxHeight: 120, marginRight: 10 },
