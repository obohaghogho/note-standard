...
const BASELINE_CURRENCY_CAPABILITIES = {
  ...
  USD: {
    ...
    type: 'fiat',
    rails: [
      { id: 'usd_card_dep', name: 'Pay by Card', type: 'card', operations: ['deposit'], provider: 'fincra', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 2.5, text: '2.5%' }, limits: { minimum: 10, maximum: 5000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'CreditCard', recommendedScore: 5, recommendationBadge: 'Instant Card' },
      { id: 'usd_ach_dep', name: 'Lead Bank ACH Transfer', type: 'ach', operations: ['deposit'], provider: 'grey', priority: 2, availability: 'ONLINE', fee: { fixed: 2, percentage: 0, text: '$2.00' }, limits: { minimum: 10, maximum: 50000 }, requiredTier: 'FREE', estimatedSettlement: '1-3 Days', icon: 'Landmark', recommendedScore: 4, recommendationBadge: 'Lead Bank ACH' },
      { id: 'usd_wire_dep', name: 'Lead Bank Wire Transfer', type: 'wire', operations: ['deposit'], provider: 'grey', priority: 3, availability: 'ONLINE', fee: { fixed: 15, percentage: 0, text: '$15.00' }, limits: { minimum: 100, maximum: 500000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Zap', recommendedScore: 4, recommendationBadge: 'Lead Bank Wire' },
      { id: 'usd_dva_dep', name: 'Lead Bank Virtual USD Account', type: 'virtual_account', operations: ['deposit'], provider: 'grey', priority: 4, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 20, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Landmark', recommendedScore: 5, recommendationBadge: 'Lead Bank USD' },
      { id: 'usd_ach_wd', name: 'ACH Payout', type: 'ach', operations: ['withdrawal'], provider: 'grey', priority: 1, availability: 'ONLINE', fee: { fixed: 1, percentage: 0, text: '$1.00' }, limits: { minimum: 10, maximum: 50000 }, requiredTier: 'FREE', estimatedSettlement: '1-2 Days', icon: 'Landmark', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'usd_wire_wd', name: 'Wire Payout', type: 'wire', operations: ['withdrawal'], provider: 'grey', priority: 2, availability: 'ONLINE', fee: { fixed: 25, percentage: 0, text: '$25.00' }, limits: { minimum: 100, maximum: 500000 }, requiredTier: 'PRO', estimatedSettlement: 'Same Day', icon: 'Zap', recommendedScore: 4, recommendationBadge: 'Fast Delivery' }
    ]
  },
  EUR: {
    currency: 'EUR',
    ...
    type: 'fiat',
    rails: [
      { id: 'eur_sepa_dep', name: 'SEPA Transfer', type: 'sepa', operations: ['deposit'], provider: 'grey', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 10, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Globe', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'eur_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'grey', priority: 2, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 10, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Building2', recommendedScore: 4, recommendationBadge: 'Best Value' },
      { id: 'eur_sepa_wd', name: 'SEPA Payout', type: 'sepa', operations: ['withdrawal'], provider: 'grey', priority: 1, availability: 'ONLINE', fee: { fixed: 0.5, percentage: 0, text: '€0.50' }, limits: { minimum: 10, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Globe', recommendedScore: 5, recommendationBadge: 'Recommended' }
    ]
  },
  GBP: {
    currency: 'GBP',
    ...
    type: 'fiat',
    rails: [
      { id: 'gbp_fp_dep', name: 'UK Faster Payments', type: 'faster_payments', operations: ['deposit'], provider: 'grey', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 5, maximum: 250000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Zap', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'gbp_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'grey', priority: 2, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 5, maximum: 250000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Building2', recommendedScore: 4, recommendationBadge: 'Best Value' },
      { id: 'gbp_fp_wd', name: 'UK Faster Payments Payout', type: 'faster_payments', operations: ['withdrawal'], provider: 'grey', priority: 1, availability: 'ONLINE', fee: { fixed: 0.5, percentage: 0, text: '£0.50' }, limits: { minimum: 5, maximum: 250000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Zap', recommendedScore: 5, recommendationBadge: 'Recommended' }
    ]
  },
  TZS: {
    currency: 'TZS',
  ...
  GHS: {
    ...
    type: 'fiat',
    rails: [
      { id: 'ghs_card_dep', name: 'Pay by Card', type: 'card', operations: ['deposit'], provider: 'fincra', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 2.0, text: '2.0%' }, limits: { minimum: 5, maximum: 20000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'CreditCard', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'ghs_momo_dep', name: 'Mobile Money (MTN / Vodafone)', type: 'mobile_money', operations: ['deposit'], provider: 'fincra', priority: 2, availability: 'ONLINE', fee: { fixed: 0, percentage: 1.0, text: '1.0%' }, limits: { minimum: 5, maximum: 20000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Smartphone', recommendedScore: 4, recommendationBadge: 'Best Value' },
      { id: 'ghs_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'fincra', priority: 3, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 5, maximum: 50000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Building2', recommendedScore: 3, recommendationBadge: 'Standard' },
