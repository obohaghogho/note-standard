...
const BASELINE_CURRENCY_CAPABILITIES = {
  ...
  EUR: {
    ...
    rails: [
      ...
      { id: 'eur_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'fincra', priority: 3, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 10, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Building2', recommendedScore: 3, recommendationBadge: 'Standard' },
  ...
  GBP: {
    ...
    rails: [
      ...
      { id: 'gbp_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'fincra', priority: 3, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 5, maximum: 250000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Building2', recommendedScore: 3, recommendationBadge: 'Standard' },
  ...
  TZS: {
    ...
    type: 'fiat',
    rails: [
      { id: 'tzs_card_dep', name: 'Pay by Card', type: 'card', operations: ['deposit'], provider: 'fincra', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 2.0, text: '2.0%' }, limits: { minimum: 1000, maximum: 5000000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'CreditCard', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'tzs_momo_dep', name: 'Mobile Money (M-Pesa / Tigo)', type: 'mobile_money', operations: ['deposit'], provider: 'fincra', priority: 2, availability: 'ONLINE', fee: { fixed: 0, percentage: 1.0, text: '1.0%' }, limits: { minimum: 1000, maximum: 10000000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Smartphone', recommendedScore: 4, recommendationBadge: 'Best Value' },
      { id: 'tzs_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'fincra', priority: 3, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 1000, maximum: 50000000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Building2', recommendedScore: 3, recommendationBadge: 'Standard' },
  ...
  KES: {
    ...
    type: 'fiat',
    rails: [
      { id: 'kes_card_dep', name: 'Pay by Card', type: 'card', operations: ['deposit'], provider: 'fincra', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 2.0, text: '2.0%' }, limits: { minimum: 100, maximum: 300000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'CreditCard', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'kes_momo_dep', name: 'Mobile Money (M-Pesa)', type: 'mobile_money', operations: ['deposit'], provider: 'fincra', priority: 2, availability: 'ONLINE', fee: { fixed: 0, percentage: 1.0, text: '1.0%' }, limits: { minimum: 100, maximum: 300000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Smartphone', recommendedScore: 4, recommendationBadge: 'Best Value' },
      { id: 'kes_bank_dep', name: 'Bank Transfer', type: 'bank_transfer', operations: ['deposit'], provider: 'fincra', priority: 3, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 100, maximum: 1000000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Building2', recommendedScore: 3, recommendationBadge: 'Standard' },
  ...
  CAD: {
    ...
    type: 'fiat',
    rails: [
      { id: 'cad_card_dep', name: 'Pay by Card', type: 'card', operations: ['deposit'], provider: 'fincra', priority: 1, availability: 'ONLINE', fee: { fixed: 0, percentage: 2.5, text: '2.5%' }, limits: { minimum: 10, maximum: 5000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'CreditCard', recommendedScore: 5, recommendationBadge: 'Recommended' },
      { id: 'cad_bank_dep', name: 'Bank Transfer / EFT', type: 'bank_transfer', operations: ['deposit'], provider: 'fincra', priority: 2, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 10, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Building2', recommendedScore: 4, recommendationBadge: 'Best Value' },
