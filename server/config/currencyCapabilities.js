...
const BASELINE_CURRENCY_CAPABILITIES = {
  ...
  USD: {
    ...
    type: 'fiat',
    rails: [
      { id: 'usd_ach_dep', name: 'Lead Bank ACH Transfer', type: 'ach', operations: ['deposit'], provider: 'grey', priority: 1, availability: 'ONLINE', fee: { fixed: 2, percentage: 0, text: '$2.00' }, limits: { minimum: 10, maximum: 50000 }, requiredTier: 'FREE', estimatedSettlement: '1-3 Days', icon: 'Landmark', recommendedScore: 5, recommendationBadge: 'Lead Bank ACH' },
      { id: 'usd_wire_dep', name: 'Lead Bank Wire Transfer', type: 'wire', operations: ['deposit'], provider: 'grey', priority: 2, availability: 'ONLINE', fee: { fixed: 15, percentage: 0, text: '$15.00' }, limits: { minimum: 100, maximum: 500000 }, requiredTier: 'FREE', estimatedSettlement: 'Same Day', icon: 'Zap', recommendedScore: 4, recommendationBadge: 'Lead Bank Wire' },
      { id: 'usd_dva_dep', name: 'Lead Bank Virtual USD Account', type: 'virtual_account', operations: ['deposit'], provider: 'grey', priority: 3, availability: 'ONLINE', fee: { fixed: 0, percentage: 0, text: 'Free' }, limits: { minimum: 20, maximum: 100000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'Landmark', recommendedScore: 5, recommendationBadge: 'Lead Bank USD' },
      { id: 'usd_card_dep', name: 'Pay by Card', type: 'card', operations: ['deposit'], provider: 'fincra', priority: 4, availability: 'ONLINE', fee: { fixed: 0, percentage: 2.5, text: '2.5%' }, limits: { minimum: 10, maximum: 5000 }, requiredTier: 'FREE', estimatedSettlement: 'Instant', icon: 'CreditCard', recommendedScore: 3, recommendationBadge: 'Card Payment' },
