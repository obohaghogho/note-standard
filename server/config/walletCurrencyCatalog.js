...
const FIAT_CATALOG = [
  ...
  },
  {
    ...
    decimal_places: 2,
    provider: 'fincra',
    deposit_methods: ['card', 'apple_pay', 'google_pay', 'ach_transfer', 'domestic_wire', 'international_wire', 'virtual_account'],
    display_order: 2,
  },
  {
    code: 'EUR',
    ...
    decimal_places: 2,
    provider: 'fincra',
    deposit_methods: ['card', 'bank_transfer', 'sepa_transfer', 'international_wire', 'virtual_account'],
    display_order: 3,
  },
  {
    code: 'GBP',
    ...
    decimal_places: 2,
    provider: 'fincra',
    deposit_methods: ['card', 'bank_transfer', 'faster_payments', 'chaps', 'bacs', 'virtual_account'],
    display_order: 4,
  },
  {
    code: 'CAD',
    ...
    decimal_places: 2,
    provider: 'fincra',
    deposit_methods: ['card', 'bank_transfer', 'eft_transfer', 'domestic_wire', 'virtual_account'],
    display_order: 5,
  },
  {
    code: 'AUD',
    ...
    decimal_places: 2,
    provider: 'fincra',
    deposit_methods: ['card', 'bank_transfer', 'domestic_wire', 'virtual_account'],
    display_order: 6,
  },
];
