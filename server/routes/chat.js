...
router.post('/report-translation', translationController.reportTranslationError);

// Conversations
router.get('/conversations', chatController.getConversations);
router.post('/conversations', chatController.createConversation);
router.post('/support', chatController.createSupportChat); // NEW: User creates support chat
router.put('/conversations/:conversationId/accept', chatController.acceptConversation);
