-- Migration 110: Fix Swap Transaction Insert (Missing currency and category)
-- This migration updates execute_production_swap to ensure the transactions
-- table receives `currency`, `amount`, and most importantly `category`
-- which prevents the revenue_logs trigger from falling back to 'other_fee'
