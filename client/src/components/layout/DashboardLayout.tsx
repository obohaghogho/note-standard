...
export const DashboardLayout = () => {
    ...
    return (
        <div className="min-h-screen text-white flex relative overflow-hidden">
            ...
            />
            <main className="flex-1 ml-0 md:ml-64 min-h-screen relative flex flex-col transition-all duration-300">
                {/* Header/Top bar */}
                <header className="h-20 border-b border-white/10 flex items-center justify-between px-4 md:px-8 bg-black/20 backdrop-blur-md sticky top-0 z-40">
