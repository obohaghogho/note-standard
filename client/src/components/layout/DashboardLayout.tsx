        ...
        <div className={cn(
            ...
            <main
                className={cn(
                    ...
                    isChatActiveOnMobile && "fixed inset-x-0 top-0 z-[60] bg-gray-950 w-screen m-0 p-0 md:relative md:inset-auto md:z-0 md:bg-transparent md:ml-64 overflow-hidden"
                )}
            >
                {renderHeader()}
