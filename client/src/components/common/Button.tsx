...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = 'primary', size = 'md', fullWidth = false, loading = false, loadingText, children, disabled, ...props }, ref) => {
        return (
            <button
                ref={ref}
            ...
            >
                ...
                <span className={cn('flex items-center justify-center gap-2', { 'hidden': loading })}>{children}</span>
            </button>
        );
    }
);
