...
const rawApiUrl = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000' : 'https://note-standard-api.onrender.com');
export const API_URL = resolveLocalUrl(rawApiUrl, 'http://localhost:5000');
